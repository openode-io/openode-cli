...
Note that when you run *openode deploy* and your website is online, it will update your files, update the environment variables (if they changed), and reload your website with 0-second-downtime.
